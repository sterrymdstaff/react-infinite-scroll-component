	...
	var InfiniteScroll = (function (_Component) {
	  ...
	  _createClass(InfiniteScroll, [{
	    ...
	    value: function render() {
	      ...
	      return ContainerElement === "tbody" ? this.renderTableContent(ContainerElement, style, hasChildren, onRef) : _react2["default"].createElement(
	        "div",
	        { ref: onRef, style: outerDivStyle },
	    ...
	    value: function renderTableContent(ContainerElement, style, hasChildren, onRef) {
	      var _this4 = this;
